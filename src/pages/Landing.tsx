...
const Landing: React.FC = () => {
  ...
  const IntelligenceDots = () => (
    <div className="relative w-full max-w-3xl mx-auto my-8 lg:my-12 h-[220px]">
      <motion.div
      ...
      <motion.div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-needl-primary flex items-center justify-center shadow-xl z-10"
