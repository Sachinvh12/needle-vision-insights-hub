        ...
        <section className="py-16 md:py-24 px-4 relative z-10">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            duration: 0.7
              ...
              <motion.p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              duration: 0.7,
              delay: 0.2
            }}>Needl.ai consolidates insights from your data sources in real-time, empowering your team with actionable intelligence for confident decision making.</motion.p>
            </motion.div>

            {/* Our new advanced visualization component */}
            <AdvancedDataFlowVisualization />
            
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-wrap justify-center gap-10 mt-8">
              {['google-drive', 'dropbox', 'onedrive'].map((provider, index) => <motion.div key={provider} variants={itemVariants} className="flex flex-col items-center" whileHover={{
              y: -5,
              scale: 1.05
            }} transition={{
              type: "spring",
            ...
            delay: 0.8
              ...
              <Button onClick={() => navigate('/use-cases')} className="bg-needl-primary hover:bg-needl-dark text-white px-8 py-6 rounded-md text-lg font-medium transition-all duration-300 hover:shadow-lg" size="lg">
